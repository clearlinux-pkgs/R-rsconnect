...
Version  : 1.1.1
Release  : 71
URL      : https://cran.r-project.org/src/contrib/rsconnect_1.1.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/rsconnect_1.1.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1696462683
